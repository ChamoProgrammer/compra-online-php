						...
						<!-- /Billing Details -->
								...
								<form onsubmit="return false" id="login" class="login100-form ">
                                    ...
                                    <div class="section-title">
                                        <h2 class="login100-form-title p-b-49" >Inicia Sesion Aqui...😉</h2>
                                    </div>
                                   
                                    
                                    <div class="form-group">
                                       <label for="email">Correo</label>
                                        <input class="input input-borders" type="email" name="email" placeholder="su correo por favor...🙏" id="password" required>
                                    </div>
