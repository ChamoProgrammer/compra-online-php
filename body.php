  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <!-- Wrapper for slides-----------Envoltorio para diapositivas   -->
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							...
							<div class="shop-body">
								<h3>Coleccion De<br>Computadoras</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							...
							<div class="shop-body">
								...
								<a href="product.php?p=72" class="cta-btn">Compra Ahora...😉<i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							...
							<div class="shop-body">
								...
								<a href="product.php?p=79" class="cta-btn">Compra Ahora...😉<i class="fa fa-arrow-circle-right"></i></a>
							</div>
                            </div></a>
					</div>
					<!-- /shop -->
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab1">Telefonos</a></li>
                        ...
                        echo "
								<div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>Q . $pro_price<del class='product-old-price'>Q.990.00</del></h4>
									...
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' class='add-to-cart-btn block2-btn-towishlist' href='#'><i class='fa fa-shopping-cart'></i> añadir al carro</button>
									</div>
								</div>
...
?>
					...
					<!-- Products tab & slick---------- productos espaciado  & resbaloso -->
				</div>
				<!-- /row -->
			</div>
		...
		<!-- HOT DEAL SECTION----------SECCIÓN DE OFERTA CALIENTE -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">TRATO CALIENTE ESTE MES</h2>
							<p>Nueva colección Hasta un 50% DESCUENTO</p>
							<a class="primary-btn cta-btn" href="store.php">Compra Ahora...😉</a>
						</div>
					</div>
				</div>
				<!-- /row -->
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="#">nombre del producto va aquí</a></h3>
										<h4 class="product-price">Q.980.00<del class="product-old-price">Q.990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
